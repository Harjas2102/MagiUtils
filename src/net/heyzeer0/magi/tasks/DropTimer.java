    ...
    public static void startCounting() {
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                if(count <= 0) {
                    this.cancel();
                    Bukkit.broadcastMessage("" + ChatColor.AQUA + ChatColor.BOLD + "[" + ChatColor.RED + ChatColor.BOLD + "!" + ChatColor.AQUA + ChatColor.BOLD + "]" + ChatColor.AQUA + " Todos os drops foram removidos.");
